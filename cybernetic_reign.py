...
computer_game=st.Page(page="C:\\Users\\L E N O V O\\Desktop\\HACKSHOP\\HACKSHOP\\computer_game.py",title="start game")
pg=st.navigation(pages=[computer_game])
#st.set_page_config(layout="wide")
st.title("CYBERNETIC REIGN")
with st.container():
...
if selected=="game":
    with st.container():
        st.image("C:\\Users\\L E N O V O\\Desktop\\HACKSHOP\\HACKSHOP\\Animation - 1730657624215 (1).gif")
    with st.container():
        st.header("CYBERNETIC REIGN GAME")
